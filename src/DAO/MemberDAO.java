...
public class MemberDAO {
   ...
   public int insert(MemberDTO dto) throws Exception{
      String sql = "insert into member values (member_seq.nextval, ?,?,?,?,?,0,'N',0)";
      try(Connection con = getConnection();
            PreparedStatement psta = con.prepareStatement(sql);){
      ...
      try(Connection con = getConnection();
         ...
         try(ResultSet rs = psta.executeQuery();){
            if(rs.next()) {
               ...
               mypage = new MemberDTO(seq, id2, pw, name, phone, email, point, getout,exp);
               con.commit();
            }
         }
         return mypage;
      ...
      try(
         ...
         try(ResultSet rs = pstat.executeQuery();){
            ...
            while(rs.next()) {
               ...
               MemberDTO dto = new MemberDTO(seq, id2, pw, name, phone, email, point, getout,exp);
               list.add(dto);
            }return list;
         }
      }
   ...
   public List<MemberDTO> selectAll() throws Exception{
      ...
      try(
         ...
         while(rs.next()){
            ...
            MemberDTO dto = new MemberDTO(seq, id, pw, name, phone, email, point, getout,exp);
            list.add(dto);
   ...
   public int pointByrefunds(String id, int point) throws Exception{
   ...
   public int increaseExp(int num,String id) throws Exception {
	      String sql="update member set exp=(exp+?) where id=?";
   ...
   public List<MemberDTO> selectByRanking() throws Exception{
      ...
      try(
         ...
         try(
            ...
            if(rs.next()){
               ...
               dto = new MemberDTO(seq, id, pw, name, phone, email, point, getout,exp);
            }
            return dto;
         }
      }   
