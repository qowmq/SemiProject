...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath }/resources/css/donateMain.css?ver=2">
...
<script>
    ...
    //
       ...
       $("#mypage").on("click", function() {
          location.href = "banner.usboard?page=donation";
       })
					...
					<span class="logoText" style="font-family: 'Rock Salt', cursive;">Don't
						...
						<c:choose>
							<c:when test="${loginResult2 == null }">
								<a
									href="${pageContext.request.contextPath }/loginPage.mem?page=donation"
									class="login">로그인</a>
								<a
