...
<img src="${pageContext.request.contextPath }/resources/img/backgroundMain.jpg" class="back" style="position:fixed; z-index:-500;filter: blur(4px);">
   ...
   <div class="container">
      ...
      <div class="twofloor">
         ...
         <div style="text-align: center; ">
            <a href="#" class="submenu">Update Challenge </a>
         </div>
         <br> <br>
         <form action="update.adboard?seq=${challenge.seq}" enctype="multipart/form-data"
            ...
            <table border=1 align=center>
               ...
               <tr>
                  <td><textarea name="content" rows="30" cols="100">"${challenge.content} "</textarea>
               </tr>
               <tr>
                  <td><br>
                     <div style="text-align: center">
               ...
               <tr>
                  <td align=right>
                     ...
                     <button id=write style="background-color:black; border-radius:4px; color:white; font-family: 'BMEULJIRO';">챌린지 수정</button>
   ...
   <ul class="navi">
      ...
      <ul class="itemList">
         ...
         <li class="navi-item"></li>
         <li class="navi-item"><a href="banner.usboard" style="font-family: 양진체; font-weight:bold;"></a></li>
         <li class="navi-item"><a href="logout.mem" style="font-family: 양진체; font-weight:bold;">ADMIN PAGE</a></li>
      </ul>
   </ul>
