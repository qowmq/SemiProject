...
<body>
			...
			<table id="listboard">
				<tr>
					<th colspan=2 id="title"
						style="font-family: 'BMEULJIRO'; font-weight: 50;">회원목록
				</tr>
				<tr>
					<th width="20%"
						style="text-align: center; font-family: 'BMEULJIRO'; font-weight: 50;">회원ID
					
					<th width="80%"
						style="text-align: center; font-family: 'BMEULJIRO'; font-weight: 50;">회원명
							...
							<c:otherwise>
								<c:forEach items="${list }" var="dto">
									<tr>
										...
										<td width="80%" style="text-align: center"><a
											href="${pageContext.request.contextPath}/memberlist.adboard?id=${dto.id}">${dto.name }</a>
									</tr>
								</c:forEach>
							</c:otherwise>
						</c:choose>
					...
					<c:otherwise>
						<c:forEach items="${dto }" var="item">
							<tr>
								<td>${item.id }
								<td><a
									href="${pageContext.request.contextPath}/memberlist.adboard?id=${item.id}">${item.name }</a>
							</tr>
					...
					<td colspan=2 style="text-align: right">
						<form action="search.mem" method="post" id="searchfrm">
							<input type=text placeholder="아이디로 검색하기" name="search"
								style="font-family: 'BMEULJIRO';"> <input type="button"
								value="검색" id="searchbtn"
								style="background-color: black; border-radius: 4px; color: white; font-family: 'BMEULJIRO';">
						</form>
				</tr>
				<tr>
	...
	<div class="category">
		<div class="wrapper"
			style="background-color: white; border: 3px solid black;">
			<br>
			<div class="sidebar">
				<img
					src="https://cdns.iconmonstr.com/wp-content/assets/preview/2018/240/iconmonstr-marketing-29.png"
					style="widht: 30px; height: 30px;">
			</div>
			<div class="sidebar">
				<a href="#"
					style="font-family: 양진체; color: black; font-weight: bold;">Member
					List</a>
			</div>
			<div class="sidebar">
				<img
					src="https://iconmonstr.com/wp-content/g/gd/makefg.php?i=../assets/preview/2018/png/iconmonstr-task-thin.png&r=0&g=0&b=0"
					style="widht: 30px; height: 30px;">

			</div>
			<div class="sidebar">
				<a href="../list.adboard"
					style="font-family: 양진체; color: black; font-weight: bold; color: black">Board
					List</a>
			</div>
			<div class="sidebar">
				<img
					src="https://cdns.iconmonstr.com/wp-content/assets/preview/2018/240/iconmonstr-pencil-thin.png"
					style="widht: 30px; height: 30px;">
			</div>
			<div class="sidebar">
				<a href="writeBoard.jsp"
					style="font-family: 양진체; font-weight: bold; color: black;">write
					Board</a>
			</div>
		</div>
	</div>
	...
	<ul class="navi" style="position: absolute">
		<ul class="title">
			<li class="navi-title"><a href="${uri }"
				style="font-family: 'Rock Salt', cursive; font-size: 20px;">
					Don't Give Up </a></li>
		</ul>
		<ul class="itemList">

			<li class="navi-item"><a href="adminMyPage.jsp"
				style="font-family: 양진체; font-weight: bold;">ADMIN PAGE</a></li>
			<li class="navi-item"><button id="logoutbtn"
					style="font-family: 양진체; font-weight: bold; border: none; background-color: white">LOGOUT</button></li>
		</ul>
	</ul>
	<script
