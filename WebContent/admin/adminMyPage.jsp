...
<body>
	...
	<c:choose>
		<c:when test="${loginResult ne null}">
			<div class="container">
				<br>
				<br>
				<br>
				...
				<div class="twofloor">
					...
					<br>
					<div style="text-align: start; margin-left: 5%;">
						<a href="#" class="submenu">Member Management </a>
					</div>
					<br>
					<br>
					<div>
						<a href="memberlist.mem"
							style="margin-left: 10%; font-family: 'BMEULJIRO';">Member
							List</a>
					</div>
				...
				<div class="threefloor">
					...
					<br>
					<div style="text-align: start; margin-left: 5%;">
						<a href="#" class="submenu">Challenge Management</a>
					</div>
					<br>
					<br>
					<div>
						<a href="${pageContext.request.contextPath}/list.adboard"
							style="margin-left: 10%; font-family: 'BMEULJIRO';" id="board">Board
							List</a>
					</div>
					<br>
					...
					<div>
						<a href="writeBoard.jsp"
							style="margin-left: 10%; font-family: 'BMEULJIRO';" id="write">write
							Board</a>
					</div>
					<br>
			...
			<ul class="navi" style="position: absolute">
				...
				<ul class="itemList">
					...
					<li class="navi-item"><button id="logoutbtn"
							style="font-family: 양진체; font-weight: bold; border: none; background: none;">LOGOUT</button></li>
				</ul>
			</ul>
