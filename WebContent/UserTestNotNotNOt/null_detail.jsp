...
<img src="${pageContext.request.contextPath }/resources/img/backgroundMain.jpg" class="back" style="position:fixed; z-index:-500;filter: blur(4px);">
   ...
   <div class="container">
      <br> <br> <br>
      <div class="twofloor">
         <div class="bd-example" style="font-family: 'BMEULJIRO';">
      ...
      <div class="fourthfloor" style="font-family: 'BMEULJIRO';">
         <div class="middlethird" id="summary">${dto.content}</div>

     

      <div class="confirmDiv" style="padding-bottom: 80px; text-align:center;">
