...
<img src="${pageContext.request.contextPath }/resources/img/backgroundMain.jpg" class="back" style="position:fixed; z-index:-500;filter: blur(4px);">
   ...
   <div class="container">
      ...
      <div class="threefloor" style="font-family: 'BMEULJIRO';">
         <br> <br> <br> <br>
      ...
      <div class="fourthfloor" style="font-family: 'BMEULJIRO'; text-align:center;">
            ...
            <div class="confirmfloor">
               <div class="confirmDiv">
                  ...
                  <input type="file" name="fileImg" id="fileImg" accept="image/*"
                     onchange="checkFile(this)" style="background-color:black; border-radius:4px; color:white; font-family: 'BMEULJIRO';">
                  <button id="confirmBtn" type="button" style="background-color:black; border-radius:4px; color:white; font-family: 'BMEULJIRO';">인증하기</button>

               </div>
            </div>

            <input type="hidden" value="${recordNum}" id="recordNum" style="background-color:black; border-radius:4px; color:white; font-family: 'BMEULJIRO';">
