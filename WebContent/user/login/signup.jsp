...
.twofloor {
	border-radius: 3px; . threefloor { border-radius : 3px;
	height: 50px;
}
						...
						<div class="container">
							<div class="signup-content">
								<div class="signup-form">
									...
									<div class="form-group">
										<label for="re-pass" class="labelTag"><i
											...
											name="id" id="id" placeholder="Your Id" required="required"/> <span
											id="idresult"></span>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="re-pass" class="labelTag"><i
											...
											name="pw" id="pw2" placeholder="Repeat your password" required="required"/> <span
											id="pw2result"></span>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="re-pass" class="labelTag"><i
											class="zmdi zmdi-lock-outline"></i></label> <input type="text"
											name="phone" id="phone" placeholder="010-1234-5678" required="required"/> <span
											id="phoneresult"></span>
									</div>
									...
									<div class="form-group">
										<label for="email" class="labelTag"><i
											...
											id="email" placeholder="abc123@def.com" required="required"/> <span
											id="emailresult"></span>
									</div>
								...
								<div class="signup-image">
									<figure>
										<img
											src="${pageContext.request.contextPath }/user/login/colorlib-regform-7/images/signup-image.jpg"
											alt="sing up image">
									</figure>
								</div>
							</div>
