...
<img src="${pageContext.request.contextPath }/resources/img/backgroundMain.jpg" class="back" style="position:fixed; z-index:-500;filter: blur(4px);">
	...
	<div class="container">
		...
		<div class="fourthfloor">
			...
			<form action="${pageContext.request.contextPath}/findPwCheck.mem" method="post" id="find">
				<table class="loginbox">
					<tr>
						<th style="font-size:40px;" colspan="2">비밀번호 찾기
					</tr>

					<tr>
					   <td colspan="2">	아이디 : <input type="text" id="id" name="id" placeholder="아이디를 입력하세요." required="required">
					</tr>
					<tr>
					<td colspan="2"> 이메일 : <input type="text" id="email" name= "email" placeholder="이메일을 입력하세요." required="required">
					</tr>
					
					<tr>
						<td><input type="button" value="비밀번호 찾기" id="findpw" style="background-color:black; color:white; border-radius:4px; width:200px; height:50px;"><br>
						<td>
