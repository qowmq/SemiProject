...
<img src="${pageContext.request.contextPath }/resources/img/backgroundMain.jpg" class="back" style="position:fixed; z-index:-500;filter: blur(4px);">
   ...
   <div class="container">
      ...
      <div class="threefloor" style="text-align:center; border-bottom:0px;">
         <br> <br>
         <div style="text-align: start; margin-left: 5%;">
            <a href="#" class="submenu" style="text-align:center;">My Information Managemnet</a><br><br>
            
         </div>
         <br><br><br><br>
         <form action = "${pageContext.request.contextPath}/update.mem">
<table class="updatetable" style="margin:auto; border:1px solid black;">
               ...
               <tr>
                  ...
                  <button id="confirm" style="background-color:black; border-radius:4px; color:white; font-family: 'BMEULJIRO';">확인</button>
                   <input type="reset" value="다시입력" id="reset" style="background-color:black; border-radius:4px; color:white; font-family: 'BMEULJIRO';"></td>
               </tr>
            </table>
</form>
         <br><br>
