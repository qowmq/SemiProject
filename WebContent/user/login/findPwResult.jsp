	...
	<div class="container">
		...
		<div class="fourthfloor">
			...
			<table class="loginbox">
				<tr>
					<th style="font-size: 40px;" colspan="3">비밀번호 찾기
				</tr>
				<tr>
					<td colspan="3">
					임시 비밀번호가 ${email}로 전송되었습니다.<br>이메일이 보이지 않으면 스팸함을 확인해
						주세요.
				</tr>
				<tr>
					<td><input type="button" value="TAKE로 가기" id="goTake"
						style="background-color: black; color: white; border-radius: 4px; width: 200px; height: 50px;"><br>
					<td><input type="button" value="DONATION로 가기" id="goDonation"
						style="background-color: black; color: white; border-radius: 4px; width: 200px; height: 50px;"><br>
