...
<img src="${pageContext.request.contextPath }/resources/img/backgroundMain.jpg" class="back" style="position:fixed; z-index:-500;filter: blur(4px);">
	...
	<div class="container">
		...
		<div class="fourthfloor">
			...
			<form action="${pageContext.request.contextPath}/findid.mem" method="post" id="find">
				<table class="loginbox">
					...
					<tr>
					   <td colspan="2">	이름 : <input type="text" name="name"  placeholder="이름을 입력하세요." required="required">
					</tr>
					<tr>
					<td colspan="2"> 이메일 : <input type="text" name= "email" placeholder="이메일을 입력하세요." required="required">
					</tr>
					
					<tr>
						<td><input type="button" value="아이디 찾기" id="findid" style="background-color:black; color:white; border-radius:4px; width:200px; height:50px;"><br>
						<td>
