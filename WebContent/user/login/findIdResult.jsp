...
<body>
	...
	<div class="container">
		...
		<div class="fourthfloor">
			...
			<table class="loginbox">
				<tr>
					<th style="font-size: 40px;" colspan="2">아이디 찾기
				</tr>
				<c:choose>
					<c:when test="${list.size() eq 0}">
						<tr>
							<td colspan="2">입력하신 정보의 아이디가 없습니다.
						</tr>
						<tr>
							<td><input type="button" value="아이디 찾기" id="findId"
								style="background-color: black; color: white; border-radius: 4px; width: 200px; height: 50px;"><br>
							<td><input type="button" value="로그인하러가기" id="gologin"
								style="background-color: black; color: white; border-radius: 4px; width: 200px; height: 50px;">
						</tr>
					</c:when>
					<c:otherwise>
						<tr>
							<td colspan="2">아이디 : ${list[0].id }
						</tr>
						<tr>
							<td><input type="button" value="비밀번호 찾기" id="findpw"
								style="background-color: black; color: white; border-radius: 4px; width: 200px; height: 50px;"><br>
							<td><input type="button" value="로그인하러가기" id="gologin"
								style="background-color: black; color: white; border-radius: 4px; width: 200px; height: 50px;">
						</tr>
	...
	<script>
		$("#findId").on("click",function(){
			location.href = "${pageContext.request.contextPath}/user/login/findId.jsp";
		})
